				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="banner-content">
							<h1 class="wow fadeInLeft" data-wow-delay="0.3s">Study a recognized qualification with the online learning experts</h1>
							<p class="wow fadeInLeft" data-wow-delay="0.6s">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6">
						<div class="single-achieve">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt sis.</p>
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="single-news">
							<a href="single-blog.html">
								<img src="assets/img/news-img/news-img-1.jpg" alt="Image">
							</a>
