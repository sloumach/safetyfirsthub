                            ...
                            <form action="{{ route('admin.coupons.update', $coupon) }}" method="POST" class="coupon-form">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('discount_value') is-invalid @enderror" 
                                                   id="discount_value" name="discount_value" step="0.01" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control @error('expiration_date') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('expiration_date', \Carbon\Carbon::parse($coupon->expiration_date)->format('Y-m-d\TH:i')) }}" required>
                                ...
                                <div class="text-right mt-4">
                                    ...
                                    <button type="submit" class="btn btn-success btn-icon-split">
                                        ...
                                        <span class="text">Update Coupon</span>
                                    </button>
                                </div>
                            </form>
                        </div>
